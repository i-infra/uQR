...
# print('rsPoly_LUT = {')
# for k in rsPoly_LUT.keys():
#     #print(k)
#     rsPoly_LUT[k] = bytes(rsPoly_LUT[k])
#     print('    {:d}: {:s},'.format(k, str(rsPoly_LUT[k])))
# print('}')
# print('RS_BLOCK_TABLE = [')
# for row in RS_BLOCK_TABLE:
#     line = bytes(row)
#     print('    {:s},'.format(str(line)))
# print(']')
# print('PATTERN_POSITION_TABLE = [')
# for row in PATTERN_POSITION_TABLE:
#     line = bytes(row)
#     print('    {:s},'.format(str(line)))
# print(']')
